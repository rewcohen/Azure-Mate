  ...
  const steps = [
    {
      ...
      description:
        'Authenticate with your Azure Tenant via the sidebar to import subscription context and existing policies.',
      icon: LogIn,
    ...
    },
    {
      ...
      description:
        'Set global variables like Project Prefix, Environment, Location, and Cost Center tags that apply to all scripts.',
      icon: Settings,
    ...
    },
    {
      ...
      description:
        'Browse the Configuration Library to find best-practice templates for Compute, Network, and Security.',
      icon: Box,
    ...
    },
    {
      ...
      title: 'Build Plan',
      description:
        'Review your End-State Plan, check estimated costs, and export the finalized deployment scripts.',
      icon: ShoppingCart,
    ...
    },
    {
      ...
      title: 'Audit & Verify',
      description:
        'Use the Troubleshooter to scan deployed resources against your defined standards and detect drift.',
      icon: Wrench,
        ...
        <div className="relative max-w-5xl mx-auto px-8 py-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight">
              Azure Architect Mate
            </h1>
          </div>
          <p className="text-lg text-slate-400 max-w-2xl leading-relaxed">
            Your AI-powered companion for standardizing, generating, and
            auditing Azure infrastructure. Follow the workflow below to ensure
            compliant and cost-optimized deployments.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {steps.map((step) => (
            ...
            >
              ...
              <div
                className={`w-12 h-12 rounded-lg ${step.bgColor} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}
              >
        ...
        <div className="mt-12 p-6 rounded-xl bg-slate-900/50 border border-slate-800 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-400">
              You can jump to any section at any time using the sidebar.
            </p>
          </div>
          <button
