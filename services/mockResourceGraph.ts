...
export const mockSearchGraph = async (
    ...
    resources.push({
        ...
        properties: {
            ...
            subnets: [
                { name: "AzureFirewallSubnet", id: `${vnetHubId}/subnets/AzureFirewallSubnet` },
    ...
    resources.push({
        ...
        properties: {
            ...
            storageProfile: {
                osDisk: { managedDisk: { id: `${subPath}/resourceGroups/${rgName}/providers/Microsoft.Compute/disks/${vm1Name}_OsDisk` } }
            }
        }
    });
    resources.push({
